...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # It acts like reduce.  It takes all of the values of an enumerable
    # and it combines them in the given manner to produce a value
  end
  ...
  #
  # I think it was done that way because of the way that ruby would store the file in memory.
